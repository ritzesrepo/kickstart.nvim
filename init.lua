...
init.lua forked from nvim-lua/kickstart.nvim <lazy-refresh>
  https://github.com/nvim-lua/kickstart.nvim/pull/178

No longer requires plugins from ritzesrepo, catppuccin sourced from original. 
